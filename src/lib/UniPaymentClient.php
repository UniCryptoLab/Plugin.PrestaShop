...
use GuzzleHttpSix\Client;
use GuzzleHttpSix\ClientInterface;
use GuzzleHttpSix\Exception\RequestException;
use GuzzleHttpSix\Psr7\MultipartStream;
use GuzzleHttpSix\Psr7\Request;
use GuzzleHttpSix\RequestOptions;
...
class UniPaymentClient
{
     ...
     * @throws ApiException|\GuzzleHttpSix\Exception\GuzzleException on non-2xx response
     */
     ...
     * @param CreateInvoiceRequest $body (required)
     *
     * @return \GuzzleHttpSix\Promise\PromiseInterface
     * @throws \InvalidArgumentException
     */
     ...
     * @param CreateInvoiceRequest $body (required)
     *
     * @return \GuzzleHttpSix\Psr7\Request
     * @throws \InvalidArgumentException
     */
    protected function createInvoiceRequest($body)
    {
        ...
        if (isset($_tempBody)) {
            ...
            if ($httpBody instanceof \stdClass && $headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttpSix\json_encode($httpBody);
            }
            ...
            if ($multipart) {
                ...
                $httpBody = \GuzzleHttpSix\json_encode($formParams);

            } else {
                // for HTTP post (form)
                $httpBody = \GuzzleHttpSix\Psr7\build_query($formParams);
            }
        }
        ...
        $query = \GuzzleHttpSix\Psr7\build_query($queryParams);
